...
---|---|---
`victoriametrics_version` |  "1.55.0" | current version
...
cd /var/tmp/archive
wget https://github.com/VictoriaMetrics/VictoriaMetrics/releases/download/v1.55.0/victoria-metrics-amd64-v1.55.0.tar.gz
wget -O vm_checksums.txt https://github.com/VictoriaMetrics/VictoriaMetrics/releases/download/v1.55.0/victoria-metrics-arm64-v1.55.0_checksums.txt
```
