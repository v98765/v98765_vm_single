...
---|---|---
`victoriametrics_version` |  "1.69.0" | current version
...
cd /var/tmp/archive
wget https://github.com/VictoriaMetrics/VictoriaMetrics/releases/download/v1.69.0/victoria-metrics-amd64-v1.69.0.tar.gz
```
